...
static Map<size_t, winrt::com_ptr<ID3D12PipelineState>> g_GraphicsPipelineStateMap{};
...
void PipelineStateManager::StorePipelineState(UINT64 psoDescHash, winrt::com_ptr<ID3D12PipelineState>& pso)
{
