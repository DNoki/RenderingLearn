...
namespace D3D12Core
{
    ...
    */
    ...
    public:
         ...
         * @brief 创建描述符堆
        */
        void Create(const GraphicsContext& context, D3D12_DESCRIPTOR_HEAP_TYPE type, uint32 count, bool isShaderVisible = false);
        ...
        */
         ...
         * @return
        */
        uint32 GetDescriptorsCount() const { return m_DescriptorHeapDesc.NumDescriptors; }
        /**
         * @brief 描述符堆类型
         * @return
        */
        ...
        */
         ...
         * @return
        */
        DescriptorHandle GetDescriptorHandle(uint32 index) const;
    ...
    private:
        ...
        uint32 m_DescriptorSize{};                    // 单个描述符大小
